...
export default function Hero() {
  return (
    <section className="bg-[url('../public/images/hero-bg.png')] bg-center bg-no-repeat bg-cover md:pt-[160px] md:pb-[200px] pt-[100px] pb-[120px] relative">
      <div className="page-container-fluid px-[20px] relative z-[10]">
        <div className="text-right mr-[790px]">
          ...
          <h1 className="hero-title1 w-[200px] h-auto md:w-[550px] md:h-[200px] mb-[20px] md:!mt-[10px]">
      ...
      <div className="absolute bottom-0 right-0 hidden md:block z-[5]">
        <img
